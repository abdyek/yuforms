...
/**
 * This class defines the structure of the 'authentication_code' table.
 *
 *
 *
...
class AuthenticationCodeTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = 'authentication_code';
     ...
     */
    const COL_ID = 'authentication_code.id';

    /**
     * the column name for the member_id field
     */
    const COL_MEMBER_ID = 'authentication_code.member_id';

    /**
     * the column name for the type field
     */
    const COL_TYPE = 'authentication_code.type';

    /**
     * the column name for the code field
     */
    const COL_CODE = 'authentication_code.code';

    /**
     * the column name for the trial_count field
     */
    const COL_TRIAL_COUNT = 'authentication_code.trial_count';

    /**
     * the column name for the date_time field
     */
    const COL_DATE_TIME = 'authentication_code.date_time';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'MemberId', 'Type', 'Code', 'TrialCount', 'DateTime', ),
        self::TYPE_CAMELNAME     => array('id', 'memberId', 'type', 'code', 'trialCount', 'dateTime', ),
        self::TYPE_COLNAME       => array(AuthenticationCodeTableMap::COL_ID, AuthenticationCodeTableMap::COL_MEMBER_ID, AuthenticationCodeTableMap::COL_TYPE, AuthenticationCodeTableMap::COL_CODE, AuthenticationCodeTableMap::COL_TRIAL_COUNT, AuthenticationCodeTableMap::COL_DATE_TIME, ),
        self::TYPE_FIELDNAME     => array('id', 'member_id', 'type', 'code', 'trial_count', 'date_time', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'MemberId' => 1, 'Type' => 2, 'Code' => 3, 'TrialCount' => 4, 'DateTime' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'memberId' => 1, 'type' => 2, 'code' => 3, 'trialCount' => 4, 'dateTime' => 5, ),
        self::TYPE_COLNAME       => array(AuthenticationCodeTableMap::COL_ID => 0, AuthenticationCodeTableMap::COL_MEMBER_ID => 1, AuthenticationCodeTableMap::COL_TYPE => 2, AuthenticationCodeTableMap::COL_CODE => 3, AuthenticationCodeTableMap::COL_TRIAL_COUNT => 4, AuthenticationCodeTableMap::COL_DATE_TIME => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'member_id' => 1, 'type' => 2, 'code' => 3, 'trial_count' => 4, 'date_time' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'member_id' => 'MEMBER_ID',
        'authentication_code.member_id' => 'MEMBER_ID',
        'Type' => 'TYPE',
        ...
        'authentication_code.trial_count' => 'TRIAL_COUNT',
        'DateTime' => 'DATE_TIME',
        ...
        'date_time' => 'DATE_TIME',
        'authentication_code.date_time' => 'DATE_TIME',
    ];
    ...
    {
        // attributes
        $this->setName('authentication_code');
  ...
  array (
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(AuthenticationCodeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(AuthenticationCodeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new AuthenticationCodeTableMap());
        }
    }
    ...
    /**
     * Deletes all rows from the authentication_code table.
     *
     * @param ConnectionInterface $con the connection to use
...
//
AuthenticationCodeTableMap::buildTableMap();
