...
abstract class Option implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OptionTableMap';
    ...
    /**
     * Initializes internal state of Base\Option object.
     */
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[OptionTableMap::COL_TEXT] = true;
        }
    ...
    public function setQuestionId($v)
    {
        ...
        if ($this->question_id !== $v) {
            $this->question_id = $v;
            $this->modifiedColumns[OptionTableMap::COL_QUESTION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Option'), 0, $e);
        }
    }
    ...
    public function getQuestion(ConnectionInterface $con = null)
    {
        if ($this->aQuestion === null && ($this->question_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aQuestion->addOptions($this);
             */
        }
