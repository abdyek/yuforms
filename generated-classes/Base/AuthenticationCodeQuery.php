...
/**
 * Base class that represents a query for the 'authentication_code' table.
 *
 *
 *
...
abstract class AuthenticationCodeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'yuforms', $modelName = '\\AuthenticationCode', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, member_id, type, code, trial_count, date_time FROM authentication_code WHERE id = :p0';
        try {
