 ...
 * @method     ChildTemplateQuery orderByFormId($order = Criteria::ASC) Order by the form_id column
 * @method     ChildTemplateQuery orderByIsPublic($order = Criteria::ASC) Order by the is_public column
 *
 * @method     ChildTemplateQuery groupById() Group by the id column
 * @method     ChildTemplateQuery groupByFormId() Group by the form_id column
 * @method     ChildTemplateQuery groupByIsPublic() Group by the is_public column
 *
 ...
 *
 * @method     ChildTemplateQuery leftJoinForm($relationAlias = null) Adds a LEFT JOIN clause to the query using the Form relation
 * @method     ChildTemplateQuery rightJoinForm($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Form relation
 * @method     ChildTemplateQuery innerJoinForm($relationAlias = null) Adds a INNER JOIN clause to the query using the Form relation
 *
 * @method     ChildTemplateQuery joinWithForm($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Form relation
 *
 * @method     ChildTemplateQuery leftJoinWithForm() Adds a LEFT JOIN clause and with to the query using the Form relation
 * @method     ChildTemplateQuery rightJoinWithForm() Adds a RIGHT JOIN clause and with to the query using the Form relation
 * @method     ChildTemplateQuery innerJoinWithForm() Adds a INNER JOIN clause and with to the query using the Form relation
 *
 * @method     \FormQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildTemplate|null findOne(ConnectionInterface $con = null) Return the first ChildTemplate matching the query
 ...
 *
 * @method     ChildTemplate|null findOneById(int $id) Return the first ChildTemplate filtered by the id column
 * @method     ChildTemplate|null findOneByFormId(int $form_id) Return the first ChildTemplate filtered by the form_id column
 * @method     ChildTemplate|null findOneByIsPublic(boolean $is_public) Return the first ChildTemplate filtered by the is_public column *
 ...
 * @method     ChildTemplate requireOneByFormId(int $form_id) Return the first ChildTemplate filtered by the form_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildTemplate requireOneByIsPublic(boolean $is_public) Return the first ChildTemplate filtered by the is_public column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildTemplate[]|ObjectCollection findByFormId(int $form_id) Return ChildTemplate objects filtered by the form_id column
 * @method     ChildTemplate[]|ObjectCollection findByIsPublic(boolean $is_public) Return ChildTemplate objects filtered by the is_public column
...
abstract class TemplateQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'yuforms', $modelName = '\\Template', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, form_id, is_public FROM template WHERE id = :p0';
        try {
    ...
    public function filterByFormId($formId = null, $comparison = null)
    {
        if (is_array($formId)) {
            $useMinMax = false;
            if (isset($formId['min'])) {
                $this->addUsingAlias(TemplateTableMap::COL_FORM_ID, $formId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($formId['max'])) {
                $this->addUsingAlias(TemplateTableMap::COL_FORM_ID, $formId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TemplateTableMap::COL_FORM_ID, $formId, $comparison);
    }
    ...
    public function filterByIsPublic($isPublic = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TemplateTableMap::COL_IS_PUBLIC, $isPublic, $comparison);
    }
    ...
    public function filterByForm($form, $comparison = null)
    {
        if ($form instanceof \Form) {
            return $this
                ->addUsingAlias(TemplateTableMap::COL_FORM_ID, $form->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(TemplateTableMap::COL_FORM_ID, $form->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
